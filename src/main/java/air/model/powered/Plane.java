...
public class Plane extends PoweredCraft {
    protected Plane(int id, String name, int passengerCapacity, int capacity, int carryingCapacity, int takeOffWeight, int maximumTakeOffWeight, int flightRange, int rangeWithMaximumLoad, int cruisingSpeed, int maximumSpeed, int maxSpeedAtHeight, int emptyWeight, int maximumHeight, int practicalRange, int practicalRangeAtHeight) {
